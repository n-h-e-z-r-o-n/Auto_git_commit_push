...
def main():
    ...
    TERMINAL = tk.Label(app, text='terminal',  bg=bg_color,  activebackground=bg_color, fg="gray", activeforeground='red', font=("Courier New italic", 8), borderwidth=0, border=0)
    ...
    TERMINAL_WIDGET = tk.Text(app, bg="", fg="gray", font=("Courier New", 8), borderwidth=0, border=0)
