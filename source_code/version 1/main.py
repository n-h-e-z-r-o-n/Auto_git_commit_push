...
def main():
    ...
    PATH_lABALE = tk.Label(app, text='PATH :', fg="white", bg=bg_color, font=("Courier New", 11), anchor='e', borderwidth=0, border=0)
    ...
    TIME_RANGE = tk.Label(app, text='TIME(min):', fg="white", font=("Courier New", 10), anchor='e', borderwidth=0, border=0)
